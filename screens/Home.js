...
const Home = ({navigation}) =>{
    ...
    return(
        <View style={{flex: 1, justifyContent:'center', alignItems:'center', backgroundColor:'black'}}>
            ...
            <TouchableOpacity onPress={()=> navigation.navigate('GameOver')} style={{borderWidth: 1, borderColor:'white', borderRadius: 5, marginTop: 20, paddingVertical: 5, paddingHorizontal: 10}}>
